...
$MANGLE_DIR/bin/poly2poly -ir1 waves_s_rect.dat mangle_masks/waves_s_rect.ply
# Create waves N region ply file
$MANGLE_DIR/bin/poly2poly -ir1 waves_n_rect.dat mangle_masks/waves_n_rect.ply
