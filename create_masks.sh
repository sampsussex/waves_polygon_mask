...
$MANGLE_DIR/bin/weight -ic1 -zzero starmask_waves_n_old_radius_rule.dat mangle_masks/starmask_old_radius_rule_n_reg.ply
$MANGLE_DIR/bin/weight -ic1 -zzero starmask_waves_s_old_radius_rule.dat mangle_masks/starmask_old_radius_rule_s_reg.ply
...
$MANGLE_DIR/bin/weight -ic1 -zzero ghostmask_waves_n.dat mangle_masks/ghostmask_n_reg.ply
$MANGLE_DIR/bin/weight -ic1 -zzero ghostmask_waves_s.dat mangle_masks/ghostmask_s_reg.ply
